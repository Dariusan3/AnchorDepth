...
def main():
    ...
    parser.add_argument("--tta", type=str, default=None, choices=["flip", "multiscale", "full"],
                        help="Test-time augmentation mode for fine-tuned model")
    ...
    for idx in tqdm(selected, desc="Fine-tuned"):
        ...
        if args.tta:
            ...
            pred = tta_infer(model_ft, img_tensor, f_px=f_px, mode=args.tta)
        else:
            with torch.no_grad():
