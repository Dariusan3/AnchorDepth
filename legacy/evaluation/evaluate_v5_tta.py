"""Evaluate v5 model (LoRA + 2 unfrozen blocks) WITH TTA flip on 654 Eigen test images."""
...
def main():
    ...
    for idx in tqdm(test_indices, desc="v5 + TTA flip"):
    ...
    with open("eval_results_v5_tta.json", "w") as out:
    ...
    print(f"Saved to eval_results_v5_tta.json")
