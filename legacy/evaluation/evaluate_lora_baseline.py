"""Evaluate LoRA model WITHOUT TTA on 654 Eigen test images."""
...
def main():
    ...
    for idx in tqdm(test_indices, desc="LoRA baseline"):
    ...
    with open("eval_results_nyu_lora_baseline.json", "w") as out:
    ...
    print(f"Saved to eval_results_nyu_lora_baseline.json")
